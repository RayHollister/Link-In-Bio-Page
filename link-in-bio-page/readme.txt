...
== Changelog ==
0.2 Created the default channel Instagram to make it easier for websites that only have one Instgram account to deal with. 
    Now you don't have to select the Channel everytime you add a new Link in Bio. \( ﾟヮﾟ)/
0.1 Literally just converted this from a function in another plugin to its own standalone plugin.